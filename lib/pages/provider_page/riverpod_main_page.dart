            ...
            MaterialButton(
              onPressed: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => ComsumerWidgetSample()));
              },
              child: Text(
                'Consumer Widget Sample Page',
                style: TextStyle(color: Colors.blue),
              ),
            ),
            Text('Double Counter Provider Value:$doubleCounter',
            ...
            MaterialButton(
              onPressed: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => UseRefListenProviderPage()));
              },
              child: Text(
                'Use ref listen provider Page',
                style: TextStyle(color: Colors.blue),
              ),
            ),
            /*
            ...
            MaterialButton(
              onPressed: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => CounterStateProviderPage()));
              },
              child: Text(
                'Use ref listenManual provider Page',
                style: TextStyle(color: Colors.blue),
              ),
            ),
            ...
            MaterialButton(
              onPressed: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => ProviderScopePage()));
              },
              child: Text(
                'Provider Scope Page',
                style: TextStyle(color: Colors.blue),
            ...
            MaterialButton(
              onPressed: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => FlutterHooksPage()));
              },
              child: Text(
                'Flutter Hooks Page',
                style: TextStyle(color: Colors.blue),
            ...
            MaterialButton(
              onPressed: () {
                Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            SharedPreferencesCacheProviderPage()));
              },
              child: Text(
                'SharedPreferences Cache Provider Page',
                style: TextStyle(color: Colors.blue),
              ),
            ),
            MaterialButton(
              onPressed: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => ApiResponseFoodPage()));
              },
              child: Text(
                'Api Response Food Page',
                style: TextStyle(color: Colors.blue),
              ),
            ),
          ],
